...
- A Google Cloud project with Earth Engine enabled (`gigcredit-506308`, already set up locally).
...
4. Go to [code.earthengine.google.com/register](https://code.earthengine.google.com) (or
   ...
   service account's email (looks like `floodlens-backend@gigcredit-506308.iam.gserviceaccount.com`)
...
2. Before the first deploy, set these environment variables on the service (Render prompts for the
   ...
   - `EARTH_ENGINE_PROJECT` = `gigcredit-506308`
